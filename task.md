...
- `[ ]` **Phase 2: Database Schema & Authentication**
    - `[ ]` Supabase SQL Editor용 테이블 스키마 작성 (`profiles`, `habits`, `habit_logs`)
    - `[ ]` 회원가입 및 로그인 페이지 UI 구현
    - `[ ]` Supabase Auth 연동 (Session 관리 및 Middleware 설정)

- `[ ]` **Phase 3: Core Features (習慣 관리)**
    - `[ ]` 습관 생성 및 목록 조회 UI (Main Dashboard)
    - `[ ]` 습관 추가/수정/삭제 기능 구현 (Server Actions 사용)
    - `[ ]` 습관별 일일 완료 체크 및 부분 성공 기록 기능
